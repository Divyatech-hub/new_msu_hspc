    ...
    <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-md shadow-sm z-50 border-b border-gray-200">
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <Link href="/" className="flex items-center">
              <span className="text-xl font-bold text-green-800">MSU Co-ed HSPC</span>
            </Link>
          </div>
          ...
          <div className="hidden sm:flex sm:items-center sm:space-x-8">
            ...
            <Link href="/details" className="text-gray-700 hover:text-green-700">
              Details
            </Link>
            <Link href="/registration" className="text-gray-700 hover:text-green-700">
              Registration
            </Link>
      ...
      <div className={`${isOpen ? 'block' : 'hidden'} sm:hidden bg-white border-b border-gray-200`}>
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <Link href="/details" className="block px-3 py-2 text-gray-700 hover:text-green-700">
            Details
          </Link>
          <Link href="/registration" className="block px-3 py-2 text-gray-700 hover:text-green-700">
            Registration
          </Link>
